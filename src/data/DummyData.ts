import { Lap, Sample, Summary } from "../interface";

// Sample Summary Data from the given JSON example
...
// Sample Laps Data from the given JSON example
export const lapsData: Lap[] = [
  {
    startTimeInSeconds: 1661158927,
...
// Sample Heart Rate Data from the given JSON example
